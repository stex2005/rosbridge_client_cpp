...
namespace rosbridge2cpp {
	...
	{
		// Queueing is only supported in BSON mode, which is not available
		return false;
	}
	...
	{
		// Publisher queue thread is only used for BSON mode, which is not available
		// Keep thread running but do nothing
